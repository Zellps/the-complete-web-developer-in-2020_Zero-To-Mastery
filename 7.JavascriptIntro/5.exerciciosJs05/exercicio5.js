...
var checkDriverAge2 = function() {
    ...
    if (Number(age) < 18) {
	alert("Desculpe, você é novo demais para dirigir. Desligando");
}   else if (Number(age) > 18) {
	alert("Ligando. Aproveite o passeio!");
}   else if (Number(age) === 18) {
	alert("Congratulations on your first year of driving. Enjoy the ride!");
}
...
function checkDriverAge3(age) {
    ...
    if (Number(age) < 18) {
	return "Desculpe, você é novo demais para dirigir. Desligando";
}   else if (Number(age) > 18) {
	return "Ligando. Aproveite o passeio!";
}   else if (Number(age) === 18) {
